  ...
  return (
    <span
      className={cn(
        ...
        {
          'bg-hospopilot-fresh/15 text-hospopilot-deep': variant === 'green',
          'bg-red-100 text-red-800': variant === 'red',
          'bg-amber-100 text-amber-800': variant === 'yellow',
          'bg-black/5 text-hospopilot-ink/70': variant === 'gray',
          'bg-blue-100 text-blue-800': variant === 'blue',
          'bg-hospopilot-gold/15 text-hospopilot-deep': variant === 'gold',
        },
        className
      )}
      {...props}
