...
export default function StaffDelivery() {
  ...
  if (done) return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="text-xl font-semibold text-mise-ink">Delivery logged!</h2>
      <p className="text-mise-ink/50 text-sm mt-1">Record saved for {supplier}</p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 py-5 max-w-lg mx-auto space-y-4">
        <div className="bg-white rounded-2xl border border-black/[0.06] p-4 shadow-sm space-y-3">
          <div>
            <label className="text-xs font-semibold text-mise-ink/50 uppercase tracking-wide">Supplier *</label>
          ...
          <div>
            <label className="text-xs font-semibold text-mise-ink/50 uppercase tracking-wide">Items delivered *</label>
        ...
        <div className="bg-white rounded-2xl border border-black/[0.06] p-4 shadow-sm space-y-3">
          <div>
            <label className="text-xs font-semibold text-mise-ink/50 uppercase tracking-wide">Temperature (°C)</label>
            <div className="flex items-center gap-2 mt-1">
              <input type="number" step="0.1" value={temperature} onChange={e => setTemperature(e.target.value)}
                placeholder="Optional"
                className="flex-1 border border-black/[0.08] rounded-xl px-3 py-2.5 text-sm text-mise-ink bg-white focus:outline-none focus:ring-2 focus:ring-mise-mid/30" />
              <span className="text-mise-ink/40 text-sm font-medium">°C</span>
            </div>
          </div>
          <div>
            <label className="text-xs font-semibold text-mise-ink/50 uppercase tracking-wide">Condition</label>
        ...
        <div className="bg-white rounded-2xl border border-black/[0.06] p-4 shadow-sm space-y-3">
          <div>
            <label className="text-xs font-semibold text-mise-ink/50 uppercase tracking-wide">Batch / lot codes</label>
