...
export const metadata: Metadata = {
  ...
  description: 'MenuSafe Terms of Service and Allergen Disclaimer',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-8 text-gray-700 text-sm leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-bold text-gray-900">1. About MenuSafe</h2>
          <p>
            MenuSafe is a software-as-a-service (SaaS) platform that helps restaurant operators
            manage ingredient libraries, recipe costing, allergen information, and staff training.
            MenuSafe is operated by [Your Company Name] (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;).
          </p>
          <p>
            By using MenuSafe you agree to these Terms. If you are using MenuSafe on behalf of a
        ...
        <section className="space-y-3">
          ...
          <p>
            MenuSafe provides tools to help restaurant operators record, manage, and display allergen
            information. However:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
              ...
              to MenuSafe or its operators.
            </li>
            <li>
              MenuSafe uses AI (artificial intelligence) to suggest allergen data when scanning
            ...
            <li>
              MenuSafe is a management tool, not a certified food safety system. It does not replace
            ...
            <li>
              MenuSafe accepts no liability for harm, loss, or legal action arising from inaccurate
        ...
        <section className="space-y-3">
          ...
          <p>
            Certain features of MenuSafe use AI models to assist with data extraction and suggestions
        ...
        <section className="space-y-3">
          ...
          <p>
            To the maximum extent permitted by law, MenuSafe and its operators shall not be liable
          ...
          <p>
            ...
            MenuSafe shall not exceed the amount you paid us in the 12 months preceding the claim.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            by email or in-app notice. Continued use of MenuSafe after changes take effect
        ...
        <div className="pt-4 border-t border-gray-200">
          <Link href="/" className="text-sm text-green-700 hover:underline">← Back to MenuSafe</Link>
        </div>
      </div>
    </div>
  )
