  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-mise-ink">Trail History</h1>
          <p className="text-mise-ink/50 text-sm">All submitted daily trails</p>
        </div>
      </div>
        ...
        {summaries?.map(s => {
          ...
          return (
            <Link
              ...
              className="flex items-center gap-4 bg-white border border-black/[0.06] rounded-2xl p-4 shadow-sm hover:border-mise-mid/30 transition-colors"
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-mise-ink text-sm">
                ...
                <div className="flex items-center gap-3 mt-0.5">
                  ...
                  <span className="text-xs text-mise-ink/30">by {s.submitted_by}</span>
                </div>
              </div>
