    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <h1 className="text-2xl font-display font-semibold text-mise-ink">Cooking Temperatures</h1>
          <p className="text-sm text-gray-500 mt-1">Safe minimum core temperatures to destroy harmful bacteria in food.</p>
        </div>
      </div>
      <Card>
        <h2 className="text-base font-semibold text-mise-ink mb-3">Why temperature matters</h2>
      ...
      <Card>
        <h2 className="text-base font-semibold text-mise-ink mb-4">Minimum core temperatures (UK)</h2>
            ...
            <div key={food as string} className="flex gap-3 p-3 rounded-xl bg-gray-50 items-start">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between gap-2">
                  <p className="font-medium text-mise-ink text-sm">{food}</p>
