  ...
  return (
    <div className="space-y-5 max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-display font-semibold text-hospopilot-ink">Upload costing sheet</h1>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-black/[0.06] shadow-sm overflow-hidden">
          ...
          <div className="p-5 space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs font-sans font-semibold text-hospopilot-ink/40 uppercase tracking-widest mb-1.5">Cost per unit (£)</label>
              ...
              <div>
                <label className="block text-xs font-sans font-semibold text-hospopilot-ink/40 uppercase tracking-widest mb-1.5">Unit type column</label>
            ...
            {!unitCol && (
              <div>
                <label className="block text-xs font-sans font-semibold text-hospopilot-ink/40 uppercase tracking-widest mb-1.5">Default unit (applied to all rows)</label>
          ...
          {nameCol && preview.length > 0 && (
            <div className="border-t border-gray-100">
              <div className="px-5 py-3 bg-gray-50">
                <p className="text-xs font-sans font-semibold text-hospopilot-ink/40 uppercase tracking-widest">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {preview.map((p, i) => (
                      <tr key={i} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-4 py-2.5 text-hospopilot-ink/50">{p.unitType}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
