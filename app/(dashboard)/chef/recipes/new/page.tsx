      ...
      <div className="bg-hospopilot-deep/5 border border-hospopilot-deep/20 rounded-2xl p-4">
        ...
        {aiMode && (
          <div className="space-y-3">
            <p className="text-xs text-hospopilot-ink/50">
            ...
            <textarea
              ...
              rows={2}
              className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-hospopilot-gold resize-none"
            />
          ...
          {addingManual && (
            <div className="border border-green-200 bg-green-50 rounded-xl p-4 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-[1fr_110px_130px] gap-3">
                <div>
                  <label className="block text-xs font-sans font-semibold text-hospopilot-ink/40 uppercase tracking-widest mb-1.5">Name</label>
                  <input
                    type="text"
                    value={manualName}
                ...
                <div>
                  <label className="block text-xs font-sans font-semibold text-hospopilot-ink/40 uppercase tracking-widest mb-1.5">Cost (£/kg)</label>
                  <input
                    type="number"
