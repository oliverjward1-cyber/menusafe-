  ...
  return (
    <div className="space-y-6 max-w-lg">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-display font-semibold text-hospopilot-ink">Create menu</h1>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-black/[0.06] shadow-sm p-6 space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-hospopilot-gold focus:border-transparent resize-none"
          />
        </div>
